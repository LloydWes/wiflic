...
public class TokenNegotiatior {
    ...
    public static String negotiateSession() throws IOException, InterruptedException, NoSuchAlgorithmException, SignatureException, URISyntaxException, InvalidKeyException {
